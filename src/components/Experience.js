...
const Experience = () => {
  return (
    ...
    <ul>
      ...
      <ul>
        - Analyzed the general ledger and identified variances to plant managers ahead of schedule <br></br>
        - Utilizing pivot tables, vlookups and conditional formatting in Excel, distributed cost and labor reports <br></br>
      </ul>
