...
const Contact = () => {
  return (
    <div className="contactInfo" style={{textAlign:"center"}}>
      <h1> Get In Touch </h1>
        Feel free to reach out with any questions. I am always happy to connect! <br></br><br></br>
          <a href="mailto:lchan217@gmail.com"><i class="envelope outline icon"></i></a>
          ...
          <a href="https://medium.com/@lchan217" target="_blank"><i class="medium icon"></i></a>
    </div>
  );
};
